...
```
wget --no-check-certificate -O AikoR-Redis.sh https://raw.githubusercontent.com/AikoCute-Offical/AikoR-Redis-install/master/AikoR-Redis.sh && bash AikoR-Redis.sh
```


2 : Run using bash path
```
bash <(curl -ls https://raw.githubusercontent.com/AikoCute-Offical/AikoR-Redis-install/master/AikoR-Redis.sh)
```